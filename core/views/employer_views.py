...
class EmployerProfilePage(EmployerAuthMixin, DetailView):
    pk_url_kwarg = 'id'
    model = Employer
...
class EmployerRegisterPage(TemplateView):
...
class EmployerEmployeesPage(EmployerAuthMixin, PaginationMixin, ListView):
    model = Employee
